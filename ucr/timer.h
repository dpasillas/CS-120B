...
// This file was modified for easier control of the timer.
...
//#define TICKS_PER_MS 25

#define PRESCALER_64 0x03 //0000 011
#define PRESCALER_256 0x04 //0000 0100
#define PRESCALER_1024 0x05 //0000 0101
...
void TimerOn() {
	...
	TCCR0 	= 0x08 | prescaler;	// bit3bit6=10: CTC mode (clear timer on compare)
					...
					// xxxx x101: prescaler /1024
					// 0000 1101: 0x0D
					// @ 16MHz, 16,000,000 / 256 = 15,625 ticks/s
					//
